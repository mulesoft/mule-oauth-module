...
public class OAuthOperations {
   ...
   */
  public void invalidateOauthContext(@Expression(NOT_SUPPORTED) @AllowedStereotypes(TokenManagerStereotype.class) TokenManagerConfig tokenManager,
  ...
  public String retrieveAccessToken(@Expression(NOT_SUPPORTED) @AllowedStereotypes(TokenManagerStereotype.class) TokenManagerConfig tokenManager,
                                    @Optional(defaultValue = DEFAULT_RESOURCE_OWNER_ID) String resourceOwnerId) {
    validateResourceOwnerId(resourceOwnerId);
   ...
   */
  @MediaType(value = TEXT_PLAIN, strict = false)
  public String retrieveRefreshToken(@Expression(NOT_SUPPORTED) @AllowedStereotypes(TokenManagerStereotype.class) TokenManagerConfig tokenManager,
                                     @Optional(defaultValue = DEFAULT_RESOURCE_OWNER_ID) String resourceOwnerId) {
   ...
   */
  @MediaType(value = TEXT_PLAIN, strict = false)
  public String retrieveExpiresIn(@Expression(NOT_SUPPORTED) @AllowedStereotypes(TokenManagerStereotype.class) TokenManagerConfig tokenManager,
                                  @Optional(defaultValue = DEFAULT_RESOURCE_OWNER_ID) String resourceOwnerId) {
   ...
   */
  @MediaType(value = TEXT_PLAIN, strict = false)
  public String retrieveState(@Expression(NOT_SUPPORTED) @AllowedStereotypes(TokenManagerStereotype.class) TokenManagerConfig tokenManager,
                              @Optional(defaultValue = DEFAULT_RESOURCE_OWNER_ID) String resourceOwnerId) {
    return getContextForResourceOwner(tokenManager, resourceOwnerId).getState();
  }

  /**
   * Returns the value of the parameter that was extracted during the dance from the token manager for the parameterized resource
   * owner ID
   *
   * @param tokenManager The token manager which holds the access token.
   * @param resourceOwnerId The resource owner id to invalidate. This attribute is only allowed for authorization code grant type.
   ...
   */
  @MediaType(value = TEXT_PLAIN, strict = false)
  public String retrieveCustomTokenResponseParam(@Expression(NOT_SUPPORTED) @AllowedStereotypes(TokenManagerStereotype.class) TokenManagerConfig tokenManager,
                                                 @Optional(defaultValue = DEFAULT_RESOURCE_OWNER_ID) String resourceOwnerId,
                                                 String key) {
